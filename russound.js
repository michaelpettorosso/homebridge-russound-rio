...
function rio(config) {
    ...
    const getControllerConfig = (controller = 1) => {
        if (getConfig('controllerConfig')) {
            var controllerConfig = getConfig('controllerConfig');
